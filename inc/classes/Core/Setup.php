...
class Setup {
    ...
    public function __construct() {
        ...
        add_action( 'after_setup_theme', [ $this, 'triboon_theme_content_width' ], 0 );
        add_action( 'widgets_init', [ $this, 'triboon_theme_widgets_init' ] );
        add_action( 'wp_enqueue_scripts', [ $this, 'triboon_theme_scripts' ] );
	...
	*/
     ...
     */
    public function triboon_theme_content_width ()
    {
     ...
     */
    public function triboon_theme_widgets_init ()
    {
        register_sidebar( [
     ...
     */
    public function triboon_theme_scripts ()
    {
